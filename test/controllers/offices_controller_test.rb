...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { election_id: @office.election_id, name: @office.name, order: @office.order } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { election_id: @office.election_id, name: @office.name, order: @office.order } }
